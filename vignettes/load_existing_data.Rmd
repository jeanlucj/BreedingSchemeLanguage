...
```{r defineSpecies}
simEnv <- defineSpecies(loadData=NULL, importFounderHap=filePathName, saveSpeciesData=FALSE,  nChr=5, lengthChr=100, nMarkers=300)
...
select(nSelect=5)
cross()
cycleMeans <- plotData(savePlotData=FALSE)
```
